...
using System.Linq;
using Products_tests;
using Product.Sevices;

namespace Product_tests_service
{
    public class ShoppingCartControllerTest
    {
        ...
        {
            _service = new ProductItem();
            _modelC = new ShoppingCartServiceFake();
        ...
        public void Get_WhenCalled_ReturnsAllItems()
        {
            ...
            // Assert
            var items = Assert.IsType<List<ProductItem>>(okResult.Value);
        ...
        {
            // Arrange
            ProductItem testItem = new ProductItem()
            {
